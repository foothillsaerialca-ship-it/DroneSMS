/**
 * File purpose: Verifies legacy risk fields are removed or neutralized by the migration set.
 * Fallback/error behavior: Test failures identify migrations that still expose unsupported legacy risk behavior.
 * Known limitation: The audit reads migration files and does not inspect live database metadata.
 */
