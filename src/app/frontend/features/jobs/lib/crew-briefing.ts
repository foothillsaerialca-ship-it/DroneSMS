/**
 * File purpose: Defines crew-briefing roles, evidence contracts, and validation/presentation helpers.
 * Fallback/error behavior: Invalid or incomplete briefing data is normalized into explicit validation results.
 * Known limitation: Persistence and delivery failures are handled by the calling page or service layer.
 */
