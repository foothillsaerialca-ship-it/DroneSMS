/**
 * File purpose: Verifies generated proposal personnel and operational language.
 * Fallback/error behavior: Assertions fail when missing or ambiguous personnel inputs produce unsafe proposal text.
 * Known limitation: These tests cover deterministic language helpers only, not PDF layout or persistence.
 */
