/**
 * File purpose: Verifies the security-advisor audit migration is present and contains expected ACL safeguards.
 * Fallback/error behavior: Test failures flag missing or incomplete security audit coverage.
 * Known limitation: This test validates migration source text rather than the hosted database state.
 */
