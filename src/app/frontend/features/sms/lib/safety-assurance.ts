/**
 * File purpose: Defines safety-assurance options, input contracts, and review validation helpers.
 * Fallback/error behavior: Missing required explanations produce explicit validation messages and open-review decisions.
 * Known limitation: This module does not persist reviews or determine reviewer authorization.
 */
