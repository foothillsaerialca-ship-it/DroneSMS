/**
 * File purpose: Verifies management-of-change identity, routing, approval, and user-display helpers.
 * Fallback/error behavior: Assertions cover malformed identities and incomplete action collections.
 * Known limitation: These tests do not execute MOC RPCs or render review pages.
 */
