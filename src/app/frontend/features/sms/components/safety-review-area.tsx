/**
 * File purpose: Provides the safety-manager review surface for hazards, events, and management-of-change records.
 * Fallback/error behavior: Missing review data and service failures render as actionable page messages.
 * Known limitation: Approval and completion actions remain subject to server-side authorization and workflow rules.
 */
