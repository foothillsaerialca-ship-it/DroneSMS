/**
 * File purpose: Implements the beta welcome and sign-in entry page for public users.
 * Fallback/error behavior: Redirects authenticated users and surfaces authentication failures through page state.
 * Known limitation: The page relies on the configured auth provider and browser navigation state.
 */
