/**
 * File purpose: Defines preflight checklist sections, state normalization, completion validation, and packet rows.
 * Fallback/error behavior: Unknown or missing checklist states default to unresolved items.
 * Known limitation: Persistence and authorization are handled by the preflight page and database policies.
 */
